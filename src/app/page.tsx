...
export default function HomePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: 'ปลอดภัย 100%',
      description: 'ระบบรักษาความปลอดภัย มีประกันหลังได้รับสินค้าเคลมได้ทุกกรณี',
    },
    {
            ...
            <Card gaming className="text-center p-8">
              ...
              <div className="bg-gaming-darker p-6 rounded-lg border border-neon-green/20 max-w-md mx-auto">
                <div className="space-y-2">
                  <p><span className="text-muted-foreground">ธนาคาร:</span> <span className="font-medium">กสิกรไทย</span></p>
                  <p><span className="text-muted-foreground">ชื่อบัญชี:</span> <span className="font-medium">พีรพงษ์ ดีเขื่อนเพชร์</span></p>
                  <p><span className="text-muted-foreground">เลขบัญชี:</span> <span className="font-bold text-neon-green">2111381316</span></p>
                </div>
              </div>
              <Link href="/topup">
